...
export default function LeftSidebar() {
  ...
  return (
    <div
      className={`hidden md:flex flex-col transition-all duration-200 bg-sidebar-bg overflow-hidden shrink-0 ${
      ...
      <div className="shrink-0">
        ...
        <div className="px-4 py-3 flex flex-col gap-1">
          <button
            ...
            className="flex items-center gap-2 py-1.5 rounded text-sm text-sidebar-text-dim hover:text-sidebar-text hover:bg-white/10 text-left"
          >
